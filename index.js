...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN: FAIZ\n' // Nama kamu
            + 'ORG: PB BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6289613469459:+62 812-7367-7810 - +62 819-5929-3465\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
conn.on('message-new', async(m) =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Nomor: +62 812-7367-7810[ ${id.split("@s.whatsapp.net")[0]} ] => ${text}`);
